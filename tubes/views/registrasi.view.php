                ...
                <div class="card">
                    <div class="card-body">
                        <div class="offest-md-4">
                            ...
                            <form class="form-login" action="registrasi.php" method="POST">
                                <!-- Email input -->
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="password" id="form2Example2" class="form-control" placeholder="Confirm Password" name="confirm_password" />
                                </div>
                                <!-- Submit button -->
                                <div class="">
                                    <input type="submit" name="submit" value="Create new
                                        Account" class="col-12 btn btn-primary btn-block mb-4">
                                </div>
